...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vpFragmentAdapter= VPFragmentAdapter(listOf(HomeFragment(binding.vpScreenTitles),FavouritFragment(),
            AlertFragment(),SettingFragment()),supportFragmentManager,this.lifecycle)
